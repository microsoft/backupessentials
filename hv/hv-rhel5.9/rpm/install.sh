################################################################################
#
# This script is to automate installation of VSS of Linux Integration Services for 
# Microsoft Hyper-V
#
################################################################################
...
if [ "$kmodrpm" != "" ] && [ "$msrpm" != ""  ]; then
       ...
       if [ "$kmodexit" == 0 ]; then
              ...
              if [ "$msexit" != 0 ]; then
                     ...
                     echo " Linux Integration Services for VSS  Hyper-V has been installed. Please reboot your system."
              fi
       else
